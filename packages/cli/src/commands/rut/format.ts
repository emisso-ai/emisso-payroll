...
import { rutColumns } from "../../formatters/payroll-table.js";

const rutArg = Args.text({ name: "rut" }).pipe(
  Args.withDescription("RUT to format (e.g. 123456785 → 12.345.678-5)"),
);
...
).pipe(Command.withDescription("Format a RUT with dots and hyphen (12.345.678-5)"));
